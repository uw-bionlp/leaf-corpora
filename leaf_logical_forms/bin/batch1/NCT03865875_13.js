...
'-  Known eq(temporal_per(PAST)) of the following mod("pulmonary") cond("comorbidities") : severity(SEVERE) chronic() cond("obstructive pulmonary disease") ( cond() ) defined as lab("FEV 1") eq(op(LTEQ), val("50"), unit("%")) , cond("emphysema") , cond("interstitial lung disease") , and / or use of proc("supplemental oxygen") .'
